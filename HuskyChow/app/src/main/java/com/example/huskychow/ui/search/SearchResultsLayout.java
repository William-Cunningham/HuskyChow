package com.example.huskychow.ui.search;
...
import com.example.huskychow.MainActivity;
...
public class SearchResultsLayout extends LinearLayout {
    ...
    private SearchResult makeSearchResult(Restaurant restaurant) {
        SearchResult searchResult = new SearchResult(mContext); //findViewById(R.id.SearchResultExample);
